...
const en = {
  ...
  tour: {
    intro: {
      ...
      self: {
        ...
        body: 'Start with the self-assessment (1 minute) and the well-being questionnaire.',
      ...
      practice: {
        ...
        body: 'Practices in one tap, mood in one line.',
      ...
      dedication: {
        ...
        after: 'Your level goes up every 100. Skipping a day takes nothing away.',
        bridge: 'You\'ll see these stars on the practices you pick next.',
      },
      coins: {
        eyebrow: 'Coins',
        title: 'Coins become rewards you define',
        body: 'Each practice also pays coins. You choose how much: {{none}}, {{half}}, {{same}} or {{double}}.',
        exampleDedication: '+{{xp}} Dedication',
        default: 'default',
        dialA11y: '{{label}}: {{coins}} coins',
        dialA11yDefault: '{{label}}, the default: {{coins}} coins',
        rewardsBody: 'You create the rewards and their price. Redeem, and it\'s used.',
        reward1: 'A movie',
        reward2: 'Dinner out',
        reward3: 'Free afternoon',
        penalty: 'It can also price a slip — and show how many days since.',
      },
      choice: {
        eyebrow: 'Guided tour',
    ...
    pack: {
      ...
      title: '12 practices to start',
      body: 'One per area, most important first. You can change anything later.',
      top: 'Top {{count}}',
      all: 'All',
      add: {
        one: 'Add 1 practice',
        other: 'Add {{count}} practices',
      },
      continue: 'Continue',
      adding: 'Adding {{current}} of {{total}}…',
      total: 'All done once: +{{xp}} Dedication',
      skip: 'Skip',
      retry: 'Try again',
      adopted: 'already on your list',
      cadence: {
        daily: 'daily',
        weekly: 'weekly',
        monthly: 'monthly',
    ...
    m1: {
      complete: {
        title: 'Mark it done',
        body: 'Tap the check. It turns into Dedication and coins.',
      },
      drawer: {
        title: 'Done today',
        body: 'What you did today. You can undo it.',
      },
      mood: {
        title: 'Mood in one line',
        body: 'How the day went, 1 to 5. No points, no pressure.',
      },
      hold: {
        title: 'Press and hold',
        body: 'Hold to skip today, adjust or edit.',
        cta: 'Got it',
      },
    },
    m2: {
      seeAll: {
        title: 'All practices',
        body: 'All your practices. This is where you make your own.',
      },
      manage: {
        title: 'Manage',
        body: 'Manage: create, adopt, edit and reorder.',
      },
      create: {
        title: 'Tap the +',
        body: 'The + makes a practice your way.',
      },
      trains: {
        title: 'What it trains',
        body: 'Pick the sub-areas and give each 1 to 5 stars.',
      },
      often: {
        title: 'How often',
        body: 'Every day, some weekdays, or some days a month.',
      },
      coins: {
        title: 'What it\'s worth in coins',
        body: 'What it pays in coins. You can close without saving.',
    ...
    m4: {
      step1: {
        title: 'Rewards',
        body: 'Rewards you define. Tap Rewards.',
      },
      step2: {
        title: 'Your coins',
        body: 'Your balance. Every practice done adds coins.',
      },
      step3: {
        title: 'Where rewards come from',
        body: 'Create or adopt rewards here. To use one, tap {{verb}}.',
      },
    },
    m5: {
      step1: {
        title: 'Who you\'re becoming',
        body: 'Your portrait. Tap Me.',
      },
      step2: {
        title: 'Three portraits',
        body: 'How you see yourself, what you practice, who you want to be.',
      },
      step3: {
        title: 'Perceived: start here',
        body: 'Start here: rate the 6 areas in 1 minute.',
        later: 'Later',
      },
      step4: {
        title: 'Practiced: what you train',
        body: 'What your habits are training in you.',
      },
      step5: {
        title: 'Desired: your north',
        body: 'Who you want to be, area by area.',
      },
    },
    m6: {
      step1: {
        title: 'Learn',
        body: 'Short ideas with sources. Tap Learn.',
      },
      step2: {
        title: 'Made of ideas',
        body: 'Read the idea and flip the card to absorb it. Review under the bulb.',
      },
    },
    common: {
      exitTour: 'Exit tour',
    ...
    wrap: {
      ...
      body: 'Every practice you check off is a vote for who you want to become.',
    ...
    replay: {
      ...
      footnote: 'Redoing deletes nothing.',
      status: {
    ...
    errors: {
      screenAction: 'Go to the app',
      screenTitle: 'Something broke on this screen.',
  ...
  learning: {
    ...
    ideas: {
      ...
      menu: {
        open: 'Open full idea',
        openSub: "The idea's text, image and video",
        favorite: 'Add to favorites',
        favoriteSub: 'Shows up under Favorites only',
        unfavorite: 'Remove from favorites',
        unfavoriteSub: 'Still absorbed, under Show all',
