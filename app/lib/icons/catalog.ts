...
export const ICON_CATEGORIES: IconCategory[] = [
  ...
  },
  {
    ...
    entries: [
      { id: 'book', pt: 'livro', en: 'book', kw: 'ler leitura read reading estudar estudo study aprender learn romance' },
      { id: 'library', pt: 'biblioteca', en: 'library', kw: 'livros books estante shelf estudar estudo study' },
      ...
      { id: 'mdi:notebook', pt: 'caderno', en: 'notebook', kw: 'anotações notes estudo study estudar lição lesson dever homework' },
      { id: 'newspaper', pt: 'notícias', en: 'news', kw: 'jornal newspaper artigo article' },
      { id: 'easel', pt: 'quadro', en: 'whiteboard', kw: 'aula class lousa ensinar teach curso course' },
